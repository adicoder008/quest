...
export const createPost = async (postData) => {
    try {
        ...
        // Use a batch to update user stats and potentially add XP in a single operation
        ...
        // Handle XP gain after the post is successfully created
        ...
        return { id: postId, ...post, photoUrl };
