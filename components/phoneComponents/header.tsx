...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-50 flex items-center justify-between px-4 py-2 rounded-md bg-black  backdrop-saturate-150 text-white shadow-lg ">
        ...
        <div className="flex items-center gap-6">
          <Link href="/chats">
            ...
            <BiSolidMessageDetail className='text-white size-6 hover:text-white transition-colors cursor-pointer' />
          </Link>
