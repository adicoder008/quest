  ...
  return (
    <>
      <div className='bg-[#F86F0A]/10 py-10 px-4 bg-opacity-10'>
        <div className='text-5xl pb-10 text-center font-arsenal font-[400] italic py-6'>
          Everything you need for a <span className='text-[#EA6100] font-[600]'>Perfect Trip !</span>
        </div>
        <div className='flex flex-col justify-center items-center gap-6 sm:flex-row'>
          ...
          <div className='flex flex-col shadow-xl w-[85vw] min-h-[45vh] bg-[#FFFFFF]/80 rounded-xl bg-opacity-80 gap-3 sm:w-[27vw]'>
            ...
            <div className='pl-4 text-xl font-[650]'> Finish Quests. Flaunt Badges</div>
            <div className='pl-4 pb-4'>Travel’s more fun when there’s a score to beat. Stay OnQuest!</div>
          </div>
        </div>
      </div>
    </>
