...
const Page = () => {
  ...
  return (
    <>
      <p className='text-3xl h-[107/2px] w-full bg-black font-semibold p-5 text-[#EA6100]'>Account</p>
      ...
      {!isLoggedIn ? (
        <div className='bg-[#121212] text-white min-h-[800px] sm:min-h-[650px] p-5'>
          <div className='bg-[#292929] justify-center items-center rounded-xl h-[250px] p-4 my-8 mx-2 flex flex-col gap-5'>
            ...
            <div>
              <button onClick={signInLogic} className='bg-[#EA6100] text-black py-3 px-2 w-3xs text-xl rounded-3xl'>
                Sign In
              </button>
            </div>
          </div>

          <p className='text-3xl font-semibold text-[#EA6100]'>Settings</p>
          ...
          >
            <div className='flex gap-4 items-center mt-4'>
              <div><SlidersHorizontal className='text-[#EA6100]' size={28} /></div>
        ...
        <div className='bg-[#121212] text-white min-h-[800px] sm:min-h-[650px] p-5'>
          ...
          >
            <div className='flex gap-4 items-center mt-4'>
              <div><Bookmark className='text-[#EA6100]' size={28} /></div>
          ...
          >
            <div className='flex gap-4 items-center mt-4'>
              <div><Check className='text-[#EA6100]' size={28} /></div>
          ...
          >
            <div className='flex gap-4 items-center mt-4'>
              <div><LucideCalendarClock className='text-[#EA6100]' size={28} /></div>
