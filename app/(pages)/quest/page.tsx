...
// Popular Destination Card Component - Matching Explore page style
...
// Google Places Autocomplete Hook (keeping your existing implementation)
...
// Location Search Component (keeping your existing implementation)
...
const QuestPage = () => {
    ...
    return (
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="hidden md:block">
          ...
          {/* Hero Section - Expanded to half screen */}
            <div className="relative h-[50vh] w-full flex">
            {/* No empty space after Navbar */}
            <div className="flex-[0.315]" />
            {/* Hero section aligned to right */}
            <div className="flex-[2] relative h-full flex justify-end items-center">
              ...
              />
              <div className="relative h-full flex flex-col justify-center items-end px-16">
  ...
  // Creation flow (keeping your existing implementation)
