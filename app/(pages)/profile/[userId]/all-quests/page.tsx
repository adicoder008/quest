...
const PublicAllQuestsPage = () => {
    ...
    const fetchUserQuests = async (uid: string) => {
        try {
            const userQuests = await questService.getUserQuests(uid);
            // Only show public quests for other users
            setQuests(userQuests.filter(q => q.isPublic));
        } catch (error) {
        ...
        <div className="min-h-screen bg-[#121212]">
            ...
            <div className='sticky top-0 z-10 bg-black border-b border-gray-700'>
                <div className='flex items-center gap-4 px-5 py-4'>
                    ...
                    <div>
                        <h1 className='text-2xl font-semibold text-white'>Quests</h1>
                ...
                {quests.length > 0 ? (
                    ...
                    <div className='text-center py-12'>
                        <div className='bg-[#292929] rounded-xl p-8'>
                            <p className='text-gray-400 text-lg mb-2'>No public quests</p>
                        </div>
                    </div>
                )}
            </div>
...
export default PublicAllQuestsPage;
